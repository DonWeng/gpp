...
//=============================================================================
bool Entity::initialize(Input *inputPtr, int width, int height, int ncols,
                            TextureManager *textureM, Graphics *graphicPtr)
{
    input = inputPtr;                // the input system
    return(Image::initialize(graphicPtr, width, height, ncols, textureM));
}
